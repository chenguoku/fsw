...
<link href="${pageContext.request.contextPath }/css/backstageManagement.css" rel="stylesheet"></head>

<body>
    <header class="header">
        <h1 class="hd-title">发生网后台管理系统</h1>
    </header>
    <div class="body-title">学生管理</div>
    <main class="main">
        <aside class="aside">
            <ul class="aside-list">
                <li>
                    <a href="javascript:void(0) " class="active">学生管理</a>
                </li>
                <li>
        ...
        <!-- 新增试卷弹窗 -->
        <form action="managerStudentInfo.html" method="POST" class="alert">
            <!-- userId -->
...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/backstageManagement.min.js"></script></body>
